...
export default function SpecialTab({ actor, onRoll, onUpdate, onDeleteItem }: SpecialTabProps) {
    ...
    const renderItemRow = (item: any, index: number, buttonLabel: string) => {
        return (
            <div
        ...
        <div className="p-1 flex flex-col gap-6">
            ...
            <div className="relative">
                ...
                <div className="flex flex-col">
                    {actor.items.feats.map((s: any, index: number) => renderItemRow(s, index, s.system?.rollLabel || s.rollLabel || 'Use'))}
            ...
            <div className="relative">
                ...
                <div className="flex flex-col">
                    {actor.items.scrolls.map((s: any, index: number) => renderItemRow(s, index + actor.items.feats.length, 'Wield'))}
