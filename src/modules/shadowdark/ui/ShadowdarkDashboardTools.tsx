        ...
        <div className={`p-4 rounded-lg bg-black/20 border border-white/5`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <button
                    ...
                    className={`px-4 py-4 rounded font-bold ${theme.button} text-white shadow-lg hover:brightness-110 flex items-center justify-center gap-2 transition-all w-full`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-4 rounded font-bold bg-neutral-700 hover:bg-neutral-600 border border-neutral-600 text-white shadow-lg hover:brightness-110 flex items-center justify-center gap-2 transition-all w-full`}
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
